...
107.1 Not fewer than fourteen clear days before voting opens the Chair shall declare that the motion will be decided by one of three methods:
...
(a) For two-stage electronic ballots Stage 1 must be open for at least seven clear days and Stage 2 for at least five clear days; Stage-1 results must be published no fewer than 24 h before Stage 2 opens.
...
“and shall specify the ballot type chosen under Article 107 and, where relevant, the opening and closing times of each electronic voting stage.”
...
Adopting this motion will modernise and clarify British Powerlifting’s voting procedures, delivering significantly improved transparency, procedural fairness, and member engagement.
...
**Note:** AGMs should plan for a potential two-day window between Stage 1 and Stage 2 to allow time for any necessary run-off votes between conflicting amendments. This motion also mandates a formal platform compatibility and process review (e.g., of Sport80) within nine months, ensuring operational readiness and faithfulness to the Articles ahead of the 2026 AGM.
