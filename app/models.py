...
class Meeting(db.Model):
    ...
    initial_notice_date = db.Column(db.DateTime)
...
class MotionSubmission(db.Model):
    ...
    email = db.Column(db.String(255))
    seconder_id = db.Column(db.Integer, db.ForeignKey("members.id"))
    seconder_member_number = db.Column(db.String(50))
    seconder_name = db.Column(db.String(255))
    allow_clerical = db.Column(db.Boolean, default=True)
    allow_move = db.Column(db.Boolean, default=True)
    title = db.Column(db.String(255))
    text_md = db.Column(db.Text)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
